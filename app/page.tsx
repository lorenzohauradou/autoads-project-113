                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 max-w-7xl mx-auto">
                        ...
                        <div className="space-y-4">
                            <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl overflow-hidden shadow-sm">
                                <Image
                                    src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/c7af147a-d05f-45b9-9d14-a1319babf873.jpg?"
                                    alt="KAPVOE Pro-Elite Cycling Glasses - Main View"
                                    width={600}
                                    height={600}
                            ...
                            <div className="grid grid-cols-4 gap-3">
                                <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-slate-300 hover:scale-105 transition-all duration-200">
                                    <Image
                                        src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/d9c8dacb-b7a0-4b04-ba93-2381d8afca4d.jpg?"
                                        alt="KAPVOE Cycling Glasses - Alternate View"
                                        width={150}
                                        height={150}
                                ...
                                <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-slate-300 hover:scale-105 transition-all duration-200">
                                    <Image
                                        src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/c7af147a-d05f-45b9-9d14-a1319babf873.jpg?"
                                        alt="KAPVOE Cycling Glasses - Detail View"
                                        width={150}
                                        height={150}
                                        className="w-full h-full object-cover"
                                    />
                                ...
                                <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-slate-300 hover:scale-105 transition-all duration-200">
                                    <Image
                                        src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/d9c8dacb-b7a0-4b04-ba93-2381d8afca4d.jpg?"
                                        alt="KAPVOE Cycling Glasses - Side View"
                                        width={150}
                                        height={150}
                                        className="w-full h-full object-cover"
                                    />
                                ...
                                <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-slate-300 hover:scale-105 transition-all duration-200">
                                    <Image
                                        src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/c7af147a-d05f-45b9-9d14-a1319babf873.jpg?"
                                        alt="KAPVOE Cycling Glasses - Lens View"
                                        width={150}
                                        height={150}
                                        className="w-full h-full object-cover"
                                    />
                        ...
                        <div className="space-y-6 lg:space-y-8">
                            <div className="space-y-4">
                                ...
                                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-tight">
                                    KAPVOE Pro-Elite Cycling Glasses
                                </h1>
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed max-w-lg">
                                    Transform your cycling experience with advanced Revo lens technology. Crystal-clear vision and superior protection across all weather conditions.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    { icon: Sun, text: "3 Lenses Included" },
                                    { icon: Shield, text: "Impact Resistant" },
                                    { icon: Moon, text: "Night Riding Ready" },
                                ].map((feature, i) => (
                                    <div
                                        key={i}
                            ...
                            <TabsContent value="features" className="mt-8">
                                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                                    <div className="space-y-6">
                                        <h3 className="text-2xl font-bold text-slate-900">Key Strengths</h3>
                                        <div className="space-y-5">
                                            {[
                                                {
                                                    title: "Advanced Interchangeable Lens System",
                                                    description: "Quickly adapt to changing light conditions with three specialized lenses",
                                                },
                                                {
                                                    title: "Superior Comfort Engineering",
                                                    description: "Dual-injected silicone nose pads and ergonomic temple design for stable, all-day wear",
                                                },
                                                {
                                                    title: "Professional-Grade Protection",
                                                    description: "UV400 rating and impact-resistant construction for maximum safety",
                                                },
                                                {
                                                    title: "Versatile Performance Design",
                                                    description: "Compatible with prescription inserts and helmet integration",
                                                },
                                            ].map((feature, i) => (
                                    ...
                                    <div className="aspect-video bg-white rounded-2xl shadow-sm overflow-hidden flex items-center justify-center">
                                        <Image
                                            src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/d9c8dacb-b7a0-4b04-ba93-2381d8afca4d.jpg?"
                                            alt="KAPVOE Cycling Glasses features demonstration"
                                            width={480}
                                            height={360}
                                            className="w-full h-full object-cover"
                                        />
                                ...
                                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                                    <Card className="shadow-sm border-0">
                                        ...
                                        <CardContent className="space-y-4">
                                            {[
                                                { label: "Lens Technology", value: "Advanced Revo Coating" },
                                                { label: "UV Protection", value: "UV400 (100% UVA/UVB)" },
                                                { label: "Frame Material", value: "TR90 Thermoplastic" },
                                                { label: "Weight", value: "28 grams" },
                                                { label: "Lens Width", value: "140mm" },
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-white rounded-2xl p-6 shadow-sm space-y-4">
                                            {[
                                                "1x KAPVOE Pro-Elite Frame",
                                                "3x Interchangeable Lenses (Polarized, Yellow, Clear)",
                                        ...
                                        {[
                                            {
                                                ...
                                                rating: 5,
                                                date: "3 days ago",
                                                title: "Game-changing cycling glasses!",
                                                content:
                                                    "The lens clarity is incredible. I can switch between lenses in seconds during my rides. Worth every penny for serious cyclists.",
                                            },
                                            {
                                                ...
                                                rating: 5,
                                                date: "1 week ago",
                                                title: "Professional quality at its finest",
                                                content:
                                                    "Used these for a century ride in varying conditions. The yellow lens was perfect for overcast, and the polarized lens handled bright sun beautifully.",
                                            },
                                            {
                                                name: "James Chen",
                                                avatar: "JC",
                                                rating: 5,
                                                date: "2 weeks ago",
                                                title: "Finally found my perfect cycling glasses",
                                                content:
                                                    "The myopia frame compatibility is a game-changer for me. Crystal clear vision with my prescription, and the aerodynamic design is noticeable at speed.",
                                            },
                                        ].map((review, i) => (
                                        ...
                                        {[
                                            {
                                                ...
                                                answer:
                                                    "The quick-release system allows lens changes in seconds. Simply press the release buttons on the frame sides and slide the lens out. The new lens clicks securely into place.",
                                            },
                                            {
                                                question: "Are these compatible with prescription lenses?",
                                                answer:
                                                    "Yes! The included myopia frame insert allows you to add your prescription lenses while maintaining the protective benefits of the outer shield lens.",
                                            },
                                            {
                                                question: "Which lens should I use for different conditions?",
                                                answer:
                                                    "Polarized lens for bright sunny days, yellow lens for overcast/low light conditions to enhance contrast, and clear lens for night riding or indoor training.",
                                            },
                                            {
                                                question: "How durable are these glasses?",
                                                answer:
                                                    "The TR90 frame is extremely durable and flexible. The lenses are impact-resistant and come with anti-scratch coating. We back them with a 2-year warranty.",
                                            },
                                            {
                                                question: "Do they fog up during rides?",
                                                answer:
                                                    "The lenses feature advanced anti-fog coating and the frame design promotes airflow to minimize fogging, even during intense efforts.",
                                            },
                                        ].map((faq, i) => (
                                            <AccordionItem
                                                key={i}
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
                            {[
                                { name: "Pro Helmet Mount", price: "$19.99", image: "Helmet mount accessory" },
                                { name: "Lens Cleaning Kit", price: "$14.99", image: "Cleaning kit" },
                                { name: "Extra Lens Set", price: "$39.99", image: "Additional lenses" },
                                { name: "Premium Case", price: "$24.99", image: "Protective case" },
                            ].map((product, i) => (
                                <Card
                                    key={i}
